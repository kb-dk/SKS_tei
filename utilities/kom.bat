...
echo KOMMENTARER, kom.xml
for %%t in (%ts_txt% %uts_txt% %jp_txt% %bd_txt%) do (
if not exist v1.9\%%t (echo %%t dir not exist
exit /b)
echo %%t
call kn12tei\xsltproc -o v1.9\%%t\kom.xml kn12tei\kn12tei.xsl v1.8\%%t\kom.xml
if exist v1.8\%%t\ekom.xml call kn12tei\xsltproc -o v1.9\%%t\ekom.xml kn12tei\kn12tei.xsl v1.8\%%t\ekom.xml
)
