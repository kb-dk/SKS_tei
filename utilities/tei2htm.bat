...
mkdir tei.htm
for %%t in (%ts_txt% %uts_txt% %jp_txt% %p_txt% %bd_txt% %dok_txt%) do (
if not exist tei.htm\%%t md tei.htm\%%t
echo %%t
call kn12tei\xsltproc -o tei.htm\%%t\txt.htm kn12tei\tei2htm.xsl v1.9\%%t\txt.xml
if exist v1.9\%%t\txr.xml   call kn12tei\xsltproc -o tei.htm\%%t\txr.htm    kn12tei\tei2htm.txr.xsl v1.9\%%t\txr.xml
if exist v1.9\%%t\int_1.xml call kn12tei\xsltproc -o tei.htm\%%t\int_1.htm  kn12tei\tei2htm.txr.xsl v1.9\%%t\int_1.xml
if exist v1.9\%%t\int_2.xml call kn12tei\xsltproc -o tei.htm\%%t\int_2.htm  kn12tei\tei2htm.txr.xsl v1.9\%%t\int_2.xml
if exist v1.9\%%t\kom.xml   call kn12tei\xsltproc -o tei.htm\%%t\kom.htm    kn12tei\tei2htm.xsl v1.9\%%t\kom.xml
if exist v1.9\%%t\ekom.xml  call kn12tei\xsltproc -o tei.htm\%%t\ekom.htm   kn12tei\tei2htm.xsl v1.9\%%t\ekom.xml
)
